    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModal2Label">Registrar paciente</h5>
                    ...
                    <div class="tabpanel">
                        ...
                        <ul class="nav nav-tabs" role="tablist">
							<li class="nav-item" role="presentation">
								<a class="nav-link active" href="#ModalPersonales" data-toggle="tab" role="tab" aria-selected="false">Datos Personales</a>
							</li>
							<li class="nav-item" role="presentation">
							   <a class="nav-link" href="#ModalOpcionales" data-toggle="tab" role="tab" aria-selected="false">Datos Opcionales</a>
							</li>
						</ul>
                        <div class="tab-content">
                            <div id="ModalPersonales" role="tabpanel" class="tab-pane active">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-check">
                                                <input required class="form-check-input" id="SexoCreateH" name="SexoCreate" type="radio" value="H" ><label class="form-check-label">H</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" id="SexoCreateM" name="SexoCreate" type="radio" value="M"  required><label class="form-check-label">M</label>
                                            </div>
                                        </div>
                                        <!------------------EmpresaEdit--------------------->
										<div class="form-group">
                            ...
                            <div role="tabpanel" class="tab-pane" id="ModalOpcionales" >
                                <div class="card">
                                    <div class="card-body">
                                        <!--------------------RFC------------------->
                                        <div class="form-group">                           
                            ...
                            <div style="text-align:right">
                                ...
                                <button onclick="añadirAficion()" type="submit" id="btnGuardar2" class="btn btn-primary">Guardar</button>         
                            </div>
                        </div>
                    </div>
                    <input id="redireccionador" name="redireccionador" readonly type="hidden">
                    <input id="tFecNac10" name="tFecNac10" readonly type="hidden">
                    <input id="tEdad10" name="tEdad10" readonly type="hidden">
                    <input id="tTipoEdad10" name="tTipoEdad10" readonly type="hidden">
                    <input id="tSexo10" name="tSexo10" readonly type="hidden">
                    <input id="tTelefono10" name="tTelefono10" readonly type="hidden">
                    <input id="tidEmpresa10" name="tidEmpresa10" readonly type="hidden">
                </form>
            </div>
        </div>
    </div>
...
function añadirAficion(){
    $('#redireccionador').val("hola");
    var PacienteModal = document.getElementById("PacienteCreate").value;
    var FecNacModal = document.getElementById("FecNacCreate").value;
    var hombre = document.getElementById("SexoCreateH").value;
    var mujer = document.getElementById("SexoCreateM").value;
    
    if(document.getElementById("SexoCreateM").checked == true){
        $("#tSexo10").val(ObtenerSexo("M"));
        document.getElementById("SexoCreateH").checked = false;
    }
    if(document.getElementById("SexoCreateH").checked == true){
        $("#tSexo10").val(ObtenerSexo("H"));
        document.getElementById("SexoCreateM").checked = false;
    }
    var EmpresaModal = document.getElementById("EmpresaCreate").value;
    var TelefonoModal = document.getElementById("TelefonoCreate").value;
    var emailModal = document.getElementById("emailCreate").value;
    var rfcModal = document.getElementById("rfcCreate").value;
    var calleModal = document.getElementById("calleCreate").value;
    var NumeroModal = document.getElementById("NumeroCreate").value;
    var ColoniaModal = document.getElementById("ColoniaCreate").value;
    var CpModal = document.getElementById("CpCreate").value;
    var paisModal = document.getElementById("paisCreate").value;
    var EstadoModal = document.getElementById("EstadoCreate").value;
    var MunicipioModal = document.getElementById("MunicipioCreate").value;

    $("#tFecNac10").val(FecNacModal);
    $("#tEdad10").val(CalcularEdad(FecNacModal));
    $("#tTipoEdad10").val(tipo);
    $("#tidEmpresa10").val(EmpresaModal);
    $("#tTelefono10").val(TelefonoModal);
}
</script>