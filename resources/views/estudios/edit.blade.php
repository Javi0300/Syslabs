                ...
                <div class="card-body" style="margin: 5px !important; padding: 5px !important;">
                    <div id="asignacion-orden" class="container">                          
                        ...
                        <div class="row">
                            ...
                            <div class="col-7">
                                <textarea class="form-control" id="indicaciones" name="indicaciones" maxlength="70">{{$estudio->Indicaciones}}</textarea>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            ...
                            <div class="col-7">
                                <textarea class="form-control" id="notas" name="notas" maxlength="100">{{$estudio->Notas}}</textarea>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            ...
                            <div class="col-7">
                                <textarea class="form-control" id="notas_internas" name="notas_internas" maxlength="100">{{$estudio->Notas_Internas}}</textarea>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
    ...
    <div class="card-body">
        ...
        <div class="container-fluid">
            <div class="row" id="tabla_formatos">
                ...
                <div id="filaDB{{$formato->idFormato}}" class="col-md-12">
                    <div id="cardlightDB{{$formato->idFormato}}" class="card card-light" style="background-color:rgba(128, 128, 128, 0.226);">
                        <div class="card-body" style="margin: 5px !important; padding: 5px !important;">
                            <div class="container">
                                <div class="row">
                                    <input type="hidden" readonly name="idFormato[]" value="{{$formato->idFormato}}">
                                    <input type="hidden" readonly id="canceladoDB{{$formato->idFormato}}" name="cancelado[]">
                                    <input type="hidden" name="separador[]" value="{{$formato->esseparador}}">
                                    ...
                                    <div class="col-7">
                                        @if($formato->esseparador == "1")
                                        <input name="pruebaTexto" readonly value="{{$formato->Prueba}}" class="form-control" style="border-color: rgba(255, 255, 255, 0);background-color:rgba(0, 0, 0, 0);">                                           
                                            @else
