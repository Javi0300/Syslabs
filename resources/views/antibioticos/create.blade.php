  ...
  <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Registrar nuevo antibiótico</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
            <form  class="frmPacientes" id="createPacientes" action="/antibioticos/" method="POST">
                @csrf
                              ...
                              <div class="card">
                                <div class="card-body">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <input title="Sin caracteres especiales • Mínimo 2 carácteres" pattern="[A-Za-z0-9À-ÿ\u00f1\u00d1 '`.-_]*" minlength="2" maxlength="100" onkeypress="return soloLetras(event)" required class="form-control" id="descripcion" name="descripcion" tabindex="3">
                                  </div>
